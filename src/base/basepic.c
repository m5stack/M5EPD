...
FT_Error ft_create_default_module_classes(FT_Library library);

void ft_destroy_default_module_classes(FT_Library library);
...
Exit:
    if (error) ft_base_pic_free(library);
    return error;
}
