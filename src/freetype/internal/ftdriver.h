...
typedef FT_Error (*FT_Size_ResetPointsFunc)(FT_Size size, FT_F26Dot6 char_width,
                                            FT_F26Dot6 char_height,
                                            FT_UInt horz_resolution,
                                            FT_UInt vert_resolution);

typedef FT_Error (*FT_Size_ResetPixelsFunc)(FT_Size size, FT_UInt pixel_width,
...
#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
#define FT_DEFINE_DRIVERS_OLD_INTERNALS(a_, b_) a_, b_,
#else
...
#define FT_DEFINE_DRIVER(                                                  \
    ...
    init_slot_, done_slot_, old_set_char_sizes_, old_set_pixel_sizes_,     \
    load_glyph_, get_kerning_, attach_file_, get_advances_, request_size_, \
    select_size_)                                                          \
