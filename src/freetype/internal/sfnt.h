...
/*                                                                       */
typedef FT_Error (*TT_Load_SFNT_HeaderRec_Func)(TT_Face face, FT_Stream stream,
                                                FT_Long face_index,
                                                SFNT_Header sfnt);
...
/*    TT_Load_Format_Tag().                                              */
/*                                                                       */
typedef FT_Error (*TT_Load_Directory_Func)(TT_Face face, FT_Stream stream,
                                           SFNT_Header sfnt);
...
/*                                                                       */
typedef FT_Error (*TT_Set_SBit_Strike_OldFunc)(TT_Face face, FT_UInt x_ppem,
                                               FT_UInt y_ppem,
...
/*    released.                                                          */
/*                                                                       */
typedef FT_Error (*TT_CharMap_Load_Func)(TT_Face face, void* cmap,
                                         FT_Stream input);
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
typedef FT_Error (*TT_CharMap_Free_Func)(TT_Face face, void* cmap);
...
/*    FreeType error code.  0 means success.                             */
/*                                                                       */
typedef FT_Error (*TT_Get_Metrics_Func)(TT_Face face, FT_Bool vertical,
...
#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
#define FT_DEFINE_DRIVERS_OLD_INTERNAL(a) a,
#else
#define FT_DEFINE_DRIVERS_OLD_INTERNAL(a) /* empty */
#endif

#define FT_INTERNAL(a) a,

#define FT_DEFINE_SFNT_INTERFACE(                                                                                \
    class_, goto_table_, init_face_, load_face_, done_face_, get_interface_,                                     \
    load_any_, load_sfnt_header_, load_directory_, load_head_, load_hhea_,                                       \
    load_cmap_, load_maxp_, load_os2_, load_post_, load_name_, free_name_,                                       \
    load_hdmx_stub_, free_hdmx_stub_, load_kern_, load_gasp_, load_pclt_,                                        \
    load_bhed_, set_sbit_strike_stub_, load_sbits_stub_, find_sbit_image_,                                       \
    load_sbit_metrics_, load_sbit_image_, free_sbits_stub_, get_psname_,                                         \
    free_psnames_, load_charmap_stub_, free_charmap_stub_, get_kerning_,                                         \
    load_font_dir_, load_hmtx_, load_eblc_, free_eblc_, set_sbit_strike_,                                        \
    load_strike_metrics_, get_metrics_)                                                                          \
    static const SFNT_Interface class_ = {                                                                       \
        FT_INTERNAL(goto_table_) FT_INTERNAL(init_face_) FT_INTERNAL(                                            \
            load_face_) FT_INTERNAL(done_face_) FT_INTERNAL(get_interface_)                                      \
            FT_INTERNAL(load_any_) FT_DEFINE_DRIVERS_OLD_INTERNAL(                                               \
                load_sfnt_header_) FT_DEFINE_DRIVERS_OLD_INTERNAL(load_directory_)                               \
                FT_INTERNAL(load_head_) FT_INTERNAL(load_hhea_) FT_INTERNAL(                                     \
                    load_cmap_) FT_INTERNAL(load_maxp_) FT_INTERNAL(load_os2_)                                   \
                    FT_INTERNAL(load_post_) FT_INTERNAL(load_name_) FT_INTERNAL(                                 \
                        free_name_) FT_DEFINE_DRIVERS_OLD_INTERNAL(load_hdmx_stub_)                              \
                        FT_DEFINE_DRIVERS_OLD_INTERNAL(free_hdmx_stub_) FT_INTERNAL(                             \
                            load_kern_) FT_INTERNAL(load_gasp_) FT_INTERNAL(load_pclt_)                          \
                            FT_INTERNAL(load_bhed_) FT_DEFINE_DRIVERS_OLD_INTERNAL(                              \
                                set_sbit_strike_stub_) FT_DEFINE_DRIVERS_OLD_INTERNAL(load_sbits_stub_)          \
                                FT_DEFINE_DRIVERS_OLD_INTERNAL(find_sbit_image_) FT_DEFINE_DRIVERS_OLD_INTERNAL( \
                                    load_sbit_metrics_) FT_INTERNAL(load_sbit_image_)                            \
                                    FT_DEFINE_DRIVERS_OLD_INTERNAL(                                              \
                                        free_sbits_stub_) FT_INTERNAL(get_psname_)                               \
                                        FT_INTERNAL(free_psnames_) FT_DEFINE_DRIVERS_OLD_INTERNAL(               \
                                            load_charmap_stub_)                                                  \
                                            FT_DEFINE_DRIVERS_OLD_INTERNAL(                                      \
                                                free_charmap_stub_)                                              \
                                                FT_INTERNAL(get_kerning_) FT_INTERNAL(                           \
                                                    load_font_dir_) FT_INTERNAL(load_hmtx_)                      \
                                                    FT_INTERNAL(                                                 \
                                                        load_eblc_) FT_INTERNAL(free_eblc_)                      \
                                                        FT_INTERNAL(                                             \
                                                            set_sbit_strike_)                                    \
                                                            FT_INTERNAL(                                         \
...
#ifdef FT_CONFIG_OPTION_OLD_INTERNALS
#define FT_DEFINE_DRIVERS_OLD_INTERNAL(a, a_) clazz->a = a_;
#else
