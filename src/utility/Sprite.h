...
class TFT_eSprite : public TFT_eSPI {
 ...
 public:
  ...
  virtual void     pushImage(int32_t x0, int32_t y0, int32_t w, int32_t h, uint16_t *data);
  virtual void     pushImage(int32_t x0, int32_t y0, int32_t w, int32_t h, const uint16_t *data);
 ...
 private:
  ...
  virtual void*    callocSprite(int16_t width, int16_t height, uint8_t frames = 1);
